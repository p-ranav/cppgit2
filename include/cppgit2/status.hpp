...
public:
  ...
  public:
    options() {
      auto ret =
          git_status_init_options(&default_options_, GIT_STATUS_OPTIONS_VERSION);
    ...
    // Show setting
    status::show show() const { return static_cast<status::show>(c_ptr_->show); }
  ...
  public:
    ...
    size_t size() const {
      return git_status_list_entrycount(c_ptr_);
    }
